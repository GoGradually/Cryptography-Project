...
int rsaes_oaep_encrypt(const void *msg, size_t len, const void *label,
                       const void *e, const void *n, void *c, int sha2_ndx);
int rsaes_oaep_decrypt(void *msg, size_t *len, const void *label, const void *d,
                       const void *n, const void *c, int sha2_ndx);
int rsassa_pss_sign(const void *msg, size_t len, const void *d, const void *n,
